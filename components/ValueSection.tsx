      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative mb-10 sm:mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-start sm:items-center mb-8 sm:mb-12 group">
              <div className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-primary-glow to-primary-light rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border-4 border-primary-glow/30">
                <BookOpen className="w-6 h-6 sm:w-8 sm:h-8 text-bg-primary" />
              </div>
              <div className="ml-4 sm:ml-8 flex-grow">
                <div className="flex flex-col sm:flex-row sm:items-center mb-3 gap-2 sm:gap-0">
                  <span className="text-xs sm:text-sm font-semibold text-primary-glow bg-primary-glow/10 px-2 sm:px-3 py-1 rounded-full w-fit sm:mr-4">Step 1</span>
                ...
                <p className="text-primary-glow text-base sm:text-lg font-semibold mb-3 sm:mb-4">Build to Learn</p>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="bg-primary-glow/10 text-primary-glow px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">Structured knowledge</span>
                  <span className="bg-primary-glow/10 text-primary-glow px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">AI assistant</span>
                  <span className="bg-primary-glow/10 text-primary-glow px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">Real-time content</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center mb-8 sm:mb-12">
              <div className="w-6 h-6 sm:w-8 sm:h-8 border-r-2 border-b-2 border-primary-glow rotate-45 animate-pulse"></div>
            </div>

            {/* Step 2: Collaboration Network */}
            <div className="flex items-start sm:items-center mb-8 sm:mb-12 group">
              <div className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-primary-glow to-primary-light rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border-4 border-primary-glow/30">
                <Users className="w-6 h-6 sm:w-8 sm:h-8 text-bg-primary" />
              </div>
              <div className="ml-4 sm:ml-8 flex-grow">
                <div className="flex flex-col sm:flex-row sm:items-center mb-3 gap-2 sm:gap-0">
                  <span className="text-xs sm:text-sm font-semibold text-primary-glow bg-primary-glow/10 px-2 sm:px-3 py-1 rounded-full w-fit sm:mr-4">Step 2</span>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-text-primary">
                    🤝 Collaborative Growth Network
                  </h3>
                </div>
                <p className="text-primary-glow text-base sm:text-lg font-semibold mb-3 sm:mb-4">Learn to Build</p>
                <p className="text-sm sm:text-base text-text-secondary leading-relaxed mb-3 sm:mb-4">
                  Proposal-driven learning × Grant incentives × Everyone is both student and mentor
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="bg-primary-glow/10 text-primary-glow px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">Proposal learning</span>
                  <span className="bg-primary-glow/10 text-primary-glow px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">Grant incentives</span>
                  <span className="bg-primary-glow/10 text-primary-glow px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">Bidirectional mentorship</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start sm:items-center group">
              <div className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-primary-glow to-primary-light rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border-4 border-primary-glow/30">
                <Zap className="w-6 h-6 sm:w-8 sm:h-8 text-bg-primary" />
              </div>
              <div className="ml-4 sm:ml-8 flex-grow">
                <div className="flex flex-col sm:flex-row sm:items-center mb-3 gap-2 sm:gap-0">
                  <span className="text-xs sm:text-sm font-semibold text-primary-glow bg-primary-glow/10 px-2 sm:px-3 py-1 rounded-full w-fit sm:mr-4">Step 3</span>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-text-primary">
                    🔥 <span className="text-primary-glow">AI + Web3</span> Innovation Hub
                  </h3>
                </div>
                <p className="text-primary-glow text-base sm:text-lg font-semibold mb-3 sm:mb-4">Build to Impact</p>
                <p className="text-sm sm:text-base text-text-secondary leading-relaxed mb-3 sm:mb-4">
                  Summer School × Hackathons × Project Acceleration: from idea to ecosystem impact
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="bg-primary-glow/10 text-primary-glow px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">Summer School</span>
                  <span className="bg-primary-glow/10 text-primary-glow px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">Hackathons</span>
                  <span className="bg-primary-glow/10 text-primary-glow px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">Project Acceleration</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center">
          <h3 className="text-2xl sm:text-3xl font-bold text-text-primary mb-8 sm:mb-12">
            What you'll gain
          </h3>
